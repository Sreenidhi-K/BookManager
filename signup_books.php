...
<body>
    <h1> Book Manager </h1>
    <form class="sign_up_with" action="back_sign.php" method="post">
    ...
    <a type="button" name="login" id="log_log" href="login_books.php" > LOG IN </a>
...
xmlhttp.open("GET","user_avail.php?uname="+encodeURIComponent(uname.value),true);
xmlhttp.send();
}
};
</script>
